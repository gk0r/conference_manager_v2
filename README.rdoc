...
== What am I doing now?
1. Redesign the Booking model and the Create and Update actions within the controller to store the Booking object within the session hash until it's ready to be saved.
2. Create the right translation from the user entered time into the DateTime required by rails.